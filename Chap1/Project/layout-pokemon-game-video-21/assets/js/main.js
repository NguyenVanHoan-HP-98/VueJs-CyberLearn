...
Vue.createApp({
  ...
  watch: {
    ...
    "gameData.selectDeck": function (newvalue) {
      //this.gameData.selectDeck = newvalue;
      this.handleReset();
    },
  },
  computed: {
  ...
  methods: {
    ...
    handleReset() {
      ...
      this.gameData.selectCard = 4;
    },
    createPokemonDeck() {
      const deck = this.gameData.selectDeck;
      const dataPokemonList = [];
      for (let index = 0; index < deck; index++) {
        dataPokemonList.push(dataPokemon[getRandomInt(0, 99)]);
      }
